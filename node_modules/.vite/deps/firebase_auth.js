import { B as isBrowserExtension, D as Deferred, E as Component, F as extractQuerystring, H as isCloudflareWorker, I as getDefaultEmulatorHost, J as pingServer, K as isMobileCordova, L as getExperimentalSetting, N as createSubscribe, O as ErrorFactory, P as deepEqual, R as getModularInstance, T as Logger, U as isEmpty, V as isCloudWorkstation, W as isIE, X as querystringDecode, Y as querystring, c as _getProvider, f as _registerComponent, g as getApp, j as base64Decode, k as FirebaseError, n as SDK_VERSION, q as isReactNative, u as _isFirebaseServerApp, w as LogLevel, x as registerVersion, z as getUA } from "./index.esm-BkK7mQ1W.js";
...
async function handleRecaptchaFlow(authInstance, request, actionName, actionMethod, recaptchaAuthProvider) {
	if (recaptchaAuthProvider === "EMAIL_PASSWORD_PROVIDER") {
		...
		if (authInstance._getRecaptchaConfig()?.isProviderEnabled("PHONE_PROVIDER")) return actionMethod(authInstance, await injectRecaptchaFields(authInstance, request, actionName)).catch(async (error) => {
...
var IndexedDBLocalPersistence = class {
	...
	async _openDb() {
		if (this.isClosing) throw new Error("Database is closing");
	...
	*/
	...
	async _poll() {
		...
		try {
			...
			if (!this.isClosing) _logWarn(`Firebase Auth cross-tab polling failed with error: ${e}`);
			return [];
		}
	}
